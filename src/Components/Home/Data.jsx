...
export default function Data() {
    return (
        <>
            ...
            <h3 className="home__subtitle1">Hii' I am</h3>
                <h1 className='home__title'>   Nitesh Kumar
                    <svg
                        width="36"
                        height="36"
                        viewBox="0 0 48 48"
                ...
                <p className='home__description'>I'm creative Web Developer, and I'm very passionate and dedicated to my work.
                </p>
